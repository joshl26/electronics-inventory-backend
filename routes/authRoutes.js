...
router.route('/logout-all').post(authController.logoutAll);

router.route('/sessions').get(authController.getSessions);

router.route('/sessions/:sessionId').delete(authController.revokeSession);
